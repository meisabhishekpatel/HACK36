        ...
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div class="mr-auto place-self-center lg:col-span-7">
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl dark:text-white">
              Stay safe, because every choice you make matters
            </h1>
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div class="max-w-screen-md mb-8 lg:mb-16">
            <h2 class="mb-4 text-4xl font-extrabold text-gray-900 dark:text-white">
              Navigate with confidence, your safety is our priority!
            </h2>
          ...
          <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
              ...
              <p class="text-gray-500 dark:text-gray-400">
                By monitoring driver behavior and detecting signs of fatigue,
                the system proactively alerts drivers, mitigating the risks
                associated with drowsy driving and promoting safer travel
                practices.
              </p>
            </div>
            <div>
              ...
              <p class="text-gray-500 dark:text-gray-400">
                Providing users with immediate access to support services in the
            ...
            <div>
              ...
              <p class="text-gray-500 dark:text-gray-400">
                Serving as a constant reminder for drivers to adhere to
                prescribed speed limits and avoid potentially hazardous
                situations.
              </p>
            </div>
            <div>
